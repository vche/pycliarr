...
<head>
    ...
    <title>Coverage for .tox/py38/lib/python3.8/site-packages/pycliarr/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.tox/py38/lib/python3.8/site-packages/pycliarr/__init__.py</b> :
...
<div id="source">
    <p id="t1" class="run"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="nam">__version__</span> <span class="op">=</span> <span class="str">"1.0.4"</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
